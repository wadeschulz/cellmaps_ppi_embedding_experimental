...
To install CM4AI Network Embedding Tool, run this command in your terminal:

.. code-block:: console

    $ pip install cellmaps_network_embedding

This is the preferred method to install CM4AI Network Embedding Tool, as it will always install the most recent stable release.
...
The sources for CM4AI Network Embedding Tool can be downloaded from the `Github repo`_.
